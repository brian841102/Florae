...
extension StringExtension on String {
  ...
  String getWindDir() {
    switch (this) {
      case 'N': return Strings.north;
      case 'S': return Strings.south;
      case 'E': return Strings.east;
      case 'W': return Strings.west;
      case 'NE': case 'NNE': case 'ENE': return Strings.northeast;
      case 'SE': case 'ESE': case 'SSE': return Strings.southeast;
      case 'SW': case 'SSW': case 'WSW': return Strings.southwest;
      case 'NW': case 'WNW': case 'NNW': return Strings.northwest;
      default: return this;
    }
  }
...
extension DateTimeExtension on DateTime {
  ...
  String convertToDay() {
    if (day == DateTime.now().day) return Strings.today;
