...
import 'package:flutter/cupertino.dart' hide ListWheelScrollView, FixedExtentScrollController,
ListWheelChildLoopingListDelegate, ListWheelChildListDelegate, ListWheelChildBuilderDelegate,
ListWheelChildDelegate, FixedExtentMetrics, FixedExtentScrollPhysics;
...
const double _kDefaultDiameterRatio = 1.17;
...
class CustomCupertinoPicker extends StatefulWidget {
  ...
  CustomCupertinoPicker({
    ...
    this.selectionOverlay = const CupertinoPickerCustomSelectionOverlay(),
    bool looping = false,
  ...
  ///
  /// If unspecified, it defaults to a [CupertinoPickerCustomSelectionOverlay]
...
class _CustomCupertinoPickerState extends State<CustomCupertinoPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget result = DefaultTextStyle(
      style:
          textStyle.copyWith(color: CupertinoDynamicColor.maybeResolve(textStyle.color, context)),
      child: Stack(
        children: <Widget>[
          Positioned.fill(
            top: 0,
...
/// To achieve the same effect using [CupertinoPickerCustomSelectionOverlay],
...
class CupertinoPickerCustomSelectionOverlay extends StatelessWidget {
  ...
  const CupertinoPickerCustomSelectionOverlay({
    super.key,
  ...
  /// The color to fill in the background of the [CupertinoPickerCustomSelectionOverlay].
